...
angular.module('ooteyApp')
  .controller('ProductsCtrl', function ($scope, $stateParams, $location, couchService, navigationService, backStepHighlightService, products, category, selectionService, categoryTreeViewRemote, productService, titleService) {
